...
public class UIAutores extends javax.swing.JFrame {
    ...
    private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActualizarActionPerformed
        try {
            ...
            autores = negocio.consultar(Autor.class, "id = " + idActualizar, null);
            if (!autores.isEmpty()) {
                autor = autores.get(0);
                autores.clear();
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        try {
            ...
            autores = negocio.consultar(Autor.class, "id = " + idEliminar, null);
            if (!autores.isEmpty()) {
                autor = autores.get(0);
                autores.clear();
        ...
        try {
            ...
            if (esAlfaNumerico(busqueda) && !busqueda.isEmpty()) {
                try {
                    ...
                    autores = negocio.consultar(Autor.class, "id = " + String.valueOf(id) + " OR nombre LIKE '%" + busqueda + "%'", Autor.nombreAtributos()[jComboOrden.getSelectedIndex()]);
                } catch (NumberFormatException e) {
                    autores = negocio.consultar(Autor.class, "nombre LIKE '%" + busqueda + "%'", Autor.nombreAtributos()[jComboOrden.getSelectedIndex()]);
                }
                if (!autores.isEmpty()) {
                    this.cargarDatos();
                    autores.clear();
    ...
    private void jButtonMostrarTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMostrarTodosActionPerformed
        try {
            autores = negocio.consultar(Autor.class, null, Autor.nombreAtributos()[jComboOrden.getSelectedIndex()]);
            this.cargarDatos();
            autores.clear();
        } catch (RuntimeException e) {
            JOptionPane.showMessageDialog(this, "No se pudo recuperar la lista de autores: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
