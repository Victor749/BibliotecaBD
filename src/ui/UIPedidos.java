...
public class UIPedidos extends javax.swing.JFrame {
    ...
    public UIPedidos(CapaNegocio capaNegocio) {
        initComponents();
    ...
    private void mostrarTabla() {
        String [][] roster = {};
        String [] columnas = {"Libro", "Fecha y Hora"};
    ...
    private void cargarDatos() {
        ...
        for (int j = 0; j < pedidos.size(); j++) {
            ...
            this.modeloTabla.setValueAt(pedidos.get(j).getLibro_nombre(), this.modeloTabla.getRowCount() - 1, 0);
            this.modeloTabla.setValueAt(pedidos.get(j).getFecha_hora(), this.modeloTabla.getRowCount() - 1, 1);
        }
    }
