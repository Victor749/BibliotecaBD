 ...
 * @author USUARIO
 */
public class UIBorrarPrestamo extends javax.swing.JFrame {
    ...
    public UIBorrarPrestamo(CapaNegocio capaNegocio) {
        initComponents();
        this.negocio = capaNegocio;
    }
    
    public void iniciar() {
        this.setTitle("Borrar Préstamo");
        this.setLocationRelativeTo(null);
        this.setVisible(true);
        mostrarTabla();
        alquileres = new ArrayList();
        jButtonBorrarPrestamo.setEnabled(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButtonBorrarPrestamo, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void jButtonBorrarPrestamoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarPrestamoActionPerformed
        try {
            int resultado = negocio.borrarPrestamo(usuario, alquileres);
            switch (resultado) {
                case 0:
                    JOptionPane.showMessageDialog(this, "Préstamo borrado con éxito.", "OK", JOptionPane.INFORMATION_MESSAGE);
                    this.dispose();
                    break;
                default:
                    JOptionPane.showMessageDialog(this, "No se pudo borrar el préstamo. El usuario no tiene un préstamo pendiente.", "Advertencia", JOptionPane.WARNING_MESSAGE);
                    break;
            }
        } catch (RuntimeException e) {
            JOptionPane.showMessageDialog(this, "No se pudo borrar el préstamo: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButtonVerPrestamoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerPrestamoActionPerformed
        ...
        if (!alquileres.isEmpty()) {
            cargarDatos();
            jButtonBorrarPrestamo.setEnabled(true);
        } else {
