 ...
 * @author USUARIO
 */
public class UILibrosAlternativa extends javax.swing.JFrame {
    ...
    private void activarTextos(Boolean estado) {
        ...
        jTextFieldAutorId.setEditable(estado);
    }
    ...
    private void initComponents() {
        ...
        jButtonVerAutores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonVerAutoresActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGap(160, 160, 160))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(jTextFieldAutorId, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jButtonVerAutores, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActualizarActionPerformed
        try {
            ...
            if (!libros.isEmpty()) {
                ...
                jTextFieldAutorId.setText(String.valueOf(libro.getAutor_id()));
                opcion = false;
            } else {
    ...
    private void jButtonGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGrabarActionPerformed
        try {
            if (esAlfaNumerico(jTextFieldTitulo.getText())) {
                try {
                    int id_autor = Integer.parseInt(this.jTextFieldAutorId.getText());
                    if (opcion) {
                        negocio.insertar(new Libro(Integer.parseInt(jTextFieldId.getText()), jTextFieldTitulo.getText(), id_autor));
                    ...
                    JOptionPane.showMessageDialog(this, "El Id de autor debe ser un entero.", "Advertencia", JOptionPane.WARNING_MESSAGE);
                }
            } else {
